...
---
   ...
   * [we need to define desktop due to firefox weird behaviour.](#we-need-to-define-desktop-due-to-firefox-weird-behaviour)
   ...
   * [or one running in virtualbox (with some shadows)](#or-one-running-in-virtualbox-with-some-shadows)
   * [with some deep shadows and transparency](#with-some-deep-shadows-and-transparency)
         * [asus eee](#asus-eee)
         * [arch](#arch)
      * [Thanks to](#thanks-to)
      * [Issues?](#issues)

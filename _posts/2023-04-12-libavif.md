...
p.s.2. It is also possible to use denoise-noise-level thing. Using slightly noisy crop of the 7d photo and high compression here to illustrate the effect:

...
Use Oxipng if you can, it's simpler to use without any scripting, will win for single image compression every time, seems more robust as well. However pngcrush is in Debian repos. I'am assuming there is even better png crusher out there, time will tell.

...
published: true
---
<a href="#toc" id="markdown-toc-toc"><img src="{{site.baseurl}}/media/stretchBangLogo.png" style="max-width:1000px; position:relative; left:50%; transform:translate(-50%, 0%); margin-top: -70px; margin-bottom: -170px"></a>

...
var snowStorm = (function(window, document) {
  ...
  this.flakesMax = 14;           // (was 64) 128 Limit total amount of snow made (falling + sticking)
  this.flakesMaxActive = 12;      // (was 64) 64 Limit amount of snow falling at once (less = lower CPU use)
  ...
  this.vMaxX = 3;                 // 5 Maximum X velocity range for snow
